    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('/example') }}">{{ config('app.name', 'Laravel') }}</a>
            </div>
            <!-- /.navbar-header -->
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    ...
                                    <div>
                                        @include('example.widgets.progress', array('animated'=> true, 'class'=>'success', 'value'=>'40'))
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    ...
                                    <div>
                                        @include('example.widgets.progress', array('animated'=> true, 'class'=>'info', 'value'=>'20'))
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    ...
                                    <div>
                                        @include('example.widgets.progress', array('animated'=> true, 'class'=>'warning', 'value'=>'60'))
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    ...
                                    <div>
                                        @include('example.widgets.progress', array('animated'=> true,'class'=>'danger', 'value'=>'80'))
