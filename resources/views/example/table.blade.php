        ...
        <div class="row">
            <div class="col-sm-6">
                @component('example.widgets.panel')
                    ...
                    @slot('panelBody')
                        @include('example.widgets.table', array('class'=>''))
                    @endslot
                @endcomponent
            </div>
            <div class="col-sm-6">
                @component('example.widgets.panel')
                    ...
                    @slot('panelBody')
                        @include('example.widgets.table', array('class'=>'table-bordered'))
                    @endslot
                @endcomponent
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6">
                @component('example.widgets.panel')
                    ...
                    @slot('panelBody')
                        @include('example.widgets.table', array('class'=>'table-striped'))
                    @endslot
                @endcomponent
            </div>
            <div class="col-sm-6">
                @component('example.widgets.panel')
                    ...
                    @slot('panelBody')
                        @include('example.widgets.table', array('class'=>'table-hover'))
                    @endslot
                @endcomponent
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                @component('example.widgets.panel')
                    ...
                    @slot('panelBody')
                        @include('example.widgets.table', array('class'=>'table-condensed'))
                    @endslot
                @endcomponent
            </div>
            <div class="col-sm-6">
                @component('example.widgets.panel')
                    ...
                    @slot('panelBody')
                        @include('example.widgets.table', array('class'=>'table-condensed table-bordered table-striped'))
                    @endslot
                @endcomponent
            </div>
        </div>
